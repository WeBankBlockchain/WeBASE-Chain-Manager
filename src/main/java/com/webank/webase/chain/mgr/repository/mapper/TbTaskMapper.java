...
public interface TbTaskMapper {
     ...
     */
    @Insert({
        "insert into tb_task (task_type, task_status, ",
        "chain_id, group_id, ",
        "node_id, current_handler_host, ",
        "gmt_create, gmt_modified, ",
        "description, remark)",
        "values (#{taskType,jdbcType=TINYINT}, #{taskStatus,jdbcType=TINYINT}, ",
        "#{chainId,jdbcType=INTEGER}, #{groupId,jdbcType=INTEGER}, ",
        "#{nodeId,jdbcType=VARCHAR}, #{currentHandlerHost,jdbcType=VARCHAR}, ",
        "#{gmtCreate,jdbcType=TIMESTAMP}, #{gmtModified,jdbcType=TIMESTAMP}, ",
        "#{description,jdbcType=VARCHAR}, #{remark,jdbcType=LONGVARCHAR})"
    })
    ...
    @Results({
        ...
        @Result(column="task_type", property="taskType", jdbcType=JdbcType.TINYINT),
        ...
        @Result(column="current_handler_host", property="currentHandlerHost", jdbcType=JdbcType.VARCHAR),
    ...
    @Select({
        "select",
        "id, task_type, task_status, chain_id, group_id, node_id, current_handler_host, ",
        "gmt_create, gmt_modified, description, remark",
        "from tb_task",
        "where id = #{id,jdbcType=INTEGER}"
    })
    @Results({
    ...
    @Update({
        ...
        "set task_type = #{taskType,jdbcType=TINYINT},",
          ...
          "current_handler_host = #{currentHandlerHost,jdbcType=VARCHAR},",
    ...
    @Insert({
    "<script>",
        "insert into tb_task (task_type, ",
        "task_status, chain_id, ",
        "group_id, node_id, ",
        "current_handler_host, gmt_create, ",
        "gmt_modified, description, ",
        "remark)",
        "values<foreach collection=\"list\" item=\"detail\" index=\"index\" separator=\",\">(#{detail.taskType,jdbcType=TINYINT}, ",
        "#{detail.taskStatus,jdbcType=TINYINT}, #{detail.chainId,jdbcType=INTEGER}, ",
        "#{detail.groupId,jdbcType=INTEGER}, #{detail.nodeId,jdbcType=VARCHAR}, ",
        "#{detail.currentHandlerHost,jdbcType=VARCHAR}, #{detail.gmtCreate,jdbcType=TIMESTAMP}, ",
        "#{detail.gmtModified,jdbcType=TIMESTAMP}, #{detail.description,jdbcType=VARCHAR}, ",
        "#{detail.remark,jdbcType=LONGVARCHAR})</foreach></script>",
    })
