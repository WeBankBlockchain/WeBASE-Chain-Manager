...
public class ConstantCode {
    ...
    public static final RetCode SYSTEM_EXCEPTION_GET_PRIVATE_KEY_FAIL = RetCode.mark(105001,
        "system exception: please check front");
    ...
    // transaction
    public static final RetCode REQUEST_TRANSACTION_EXCEPTION = RetCode.mark(205101,
        "request transaction server exception");
    ...
    public static final RetCode REQUEST_SIGN_EXCEPTION = RetCode.mark(204203,
        "request sign server exception");
    ...
    public static final RetCode REQUEST_FRONT_FAIL = RetCode.mark(205007,
        "request front fail, please check front");
    ...
    public static final RetCode CHAIN_NAME_EXISTS = RetCode.mark(205021,
    ...
    public static final RetCode CONTRACT_COMPILE_ERROR = RetCode.mark(205030,
    ...
    public static final RetCode REQUEST_NODE_EXCEPTION = RetCode.mark(205033,
        "request node exception");
    // JSON PARSE
    ...
    public static final RetCode BUILD_TIME_NOT_MATCH = RetCode.mark(205036,
        "node's build time not match");

    // contract
    public static final RetCode CONTRACT_NOT_EXISTS = RetCode.mark(205037,
        "contract name or address not exists");
    public static final RetCode CONTRACT_TYPE_ENCODED_ERROR = RetCode.mark(201151,
        "Unsupported contract param type to encoded");
    public static final RetCode CONTRACT_TYPE_DECODED_ERROR = RetCode.mark(201152,
        "Unsupported contract param type to decoded");
...
//    public static final RetCode UNKNOWN_CONFIG_TYPE_ERROR = RetCode.mark(205203, "Unknown config type.");
    public static final RetCode SAVE_IP_CONFIG_FILE_ERROR = RetCode.mark(205204,
        "Save IP config error.");
...
//    public static final RetCode IP_CONF_PARAM_NULL_ERROR = RetCode.mark(205206, "ipconf null.");
    public static final RetCode CHAIN_NAME_EXISTS_ERROR = RetCode.mark(205207,
        "Chain name exists.");
    public static final RetCode INSERT_CHAIN_ERROR = RetCode.mark(205208,
        "Insert new chain failed.");
    //    public static final RetCode NO_CONFIG_FILE_ERROR = RetCode.mark(205209, "No ipconf file.");
    public static final RetCode EXEC_BUILD_CHAIN_ERROR = RetCode.mark(205210,
        "Exec build chain script failed.");
...
//    public static final RetCode INSERT_HOST_ERROR = RetCode.mark(205218, "Insert new host failed.");
    public static final RetCode INSERT_FRONT_ERROR = RetCode.mark(205219,
        "Insert new front failed.");
    ...
    public static final RetCode PARSE_HOST_INDEX_ERROR = RetCode.mark(205222,
        "Parse host index from node directory failed.");
...
//    public static final RetCode DEPLOY_WITH_UNKNOWN_EXCEPTION_ERROR = RetCode.mark(205224, "Unexpected exception occurred when deploy.");
    public static final RetCode UNSUPPORTED_PASSWORD_SSH_ERROR = RetCode.mark(205225,
        "SSH password login not supported yet.");
...
//    public static final RetCode ADD_NODE_WITH_UNKNOWN_EXCEPTION_ERROR = RetCode.mark(205231, "Unexpected exception occurred when add new node.");
    public static final RetCode CHAIN_CERT_NOT_EXISTS_ERROR = RetCode.mark(205232,
        "Chain cert directory not exists.");
...
//    public static final RetCode EXEC_GEN_NODE_ERROR = RetCode.mark(205237, "Exec generate node script to generate node dir failed.");
    public static final RetCode COPY_SDK_FILES_ERROR = RetCode.mark(205238,
        "Copy sdk config files error.");
...
//    public static final RetCode SEND_NODE_FILES_ERROR = RetCode.mark(205240, "Send node config files error.");
    public static final RetCode COPY_GROUP_FILES_ERROR = RetCode.mark(205241,
        "Copy original group config files error.");
...
//    public static final RetCode DELETE_OLD_NODE_DIR_ERROR = RetCode.mark(205244, "Delete old node config files error.");
    public static final RetCode NODE_ID_NOT_EXISTS_ERROR = RetCode.mark(205245,
        "Nodeid not exists.");
...
//    public static final RetCode NODE_IN_GROUP_ERROR = RetCode.mark(205250, "Node still in group, remove before deleting.");
    public static final RetCode READ_NODE_CONFIG_ERROR = RetCode.mark(205251,
        "Read node config error.");
    public static final RetCode DELETE_NODE_DIR_ERROR = RetCode.mark(205252,
        "Delete node config files error.");
...
//    public static final RetCode UPDATE_RELATED_NODE_ERROR = RetCode.mark(205254, "Update related nodes error.");
    ...
    public static final RetCode LIST_HOST_NODE_DIR_ERROR = RetCode.mark(205257,
        "List node dirs of host error.");
    public static final RetCode GENERATE_FRONT_YML_ERROR = RetCode.mark(205258,
        "Generate front application.yml file failed.");
    public static final RetCode EXEC_HOST_INIT_SCRIPT_ERROR = RetCode.mark(205259,
        "Exec host init script failed.");
    public static final RetCode TRANSFER_FILES_ERROR = RetCode.mark(205260,
        "Transfer files error.");
    public static final RetCode DOCKER_OPERATION_ERROR = RetCode.mark(205261,
        "Docker option error.");
...
//    public static final RetCode WEBASE_SIGN_CONFIG_ERROR = RetCode.mark(205264, "Please check webaseSignAddress in application.yml file.");
    public static final RetCode UNKNOWN_DOCKER_IMAGE_TYPE = RetCode.mark(205265,
        "Docker image type param error.");
    public static final RetCode IMAGE_NOT_EXISTS_ON_HOST = RetCode.mark(205266,
        "Image not exists on host.");
...
//    public static final RetCode SAME_HOST_ERROR = RetCode.mark(205268, "Cannot install node and WeBASE-Node-Manager on same host.");
    public static final RetCode CANNOT_USE_DEFAULT_GROUP_ID = RetCode.mark(205269,
        "Cannot use default group Id.");
    //    public static final RetCode CANNOT_OPERATE_DEFAULT_GROUP_ID = RetCode.mark(205269, "Cannot use default group Id.");
    public static final RetCode NODE_ID_AND_ORG_LIST_EMPTY = RetCode.mark(205270,
        "Both node id list and org id list are empty.");
    public static final RetCode DOWNLOAD_FILE_ERROR = RetCode.mark(205271,
        "Download from url error.");
    public static final RetCode FILE_NOT_EXISTS = RetCode.mark(205272, "Image tar file not exits.");
    public static final RetCode CHECK_PORT_NOT_SUCCESS = RetCode.mark(205273,
        "port check not success.");
    public static final RetCode HOST_INIT_NOT_SUCCESS = RetCode.mark(205274,
        "host init not success");
    public static final RetCode TX_RECEIPT_CODE_ERROR = RetCode.mark(205275,
        "transaction receipt status return error");
    public static final RetCode NODE_PARAM_EMPTY = RetCode.mark(205276, "nodeId input is empty");
    public static final RetCode INVALID_NODE_TYPE = RetCode.mark(205277,
        "invalid node type: sealer, observer, remove ");
    public static final RetCode INVALID_NODE_ID = RetCode.mark(205278, "invalid node id");
    public static final RetCode SET_CONSENSUS_STATUS_FAIL = RetCode.mark(205279,
        "set consensus status not success");
    public static final RetCode NOT_FOUND_OBSERVER_NODE = RetCode.mark(205280,
        "not found observer nodes");
    public static final RetCode NODE_IN_TASK = RetCode.mark(205281, "node is already in task");
    public static final RetCode ADD_SEALER_ASYNC_FAIL = RetCode.mark(205282,
        "add sealer async not success");
    public static final RetCode NOT_FOUND_GENESIS_NODE_LIST_OF_GROUP = RetCode.mark(205283,
        "not found genesis node list of this group");
    public static final RetCode SOLC_NOT_SUPPORT_OS = RetCode.mark(205284,
        "The current system does not support contract compilation");
    public static final RetCode FAIL_TO_CREATE_TEMP_FILE = RetCode.mark(205285,
        "fail to create temp file");
    public static final RetCode NODE_ID_EMPTY = RetCode.mark(205286, "node id is empty");
    public static final RetCode NOT_FOUND_GROUP_BY_AGENCY_AND_CHAIN = RetCode.mark(205287,
        "not found group by agency and chain");
    ...
    public static final RetCode IN_FUNCPARAM_ERROR = RetCode.mark(205290,
        "contract funcParam is error");
    ...
    public static final RetCode FUNCTION_NOT_EXISTS = RetCode.mark(205293,
        "function is not exists");
    public static final RetCode FOUND_TOO_MANY_DATA_BY_APP_ID = RetCode.mark(205294,
        "found too many group by appId");
    public static final RetCode INVALID_APP_ID = RetCode.mark(205295, "invalid appId");
    public static final RetCode REST_REQUEST_FAIL = RetCode.mark(205296,
        "rest server request not success");
    ...
    public static final RetCode NOT_FOUND_GROUP_BY_ID_AND_CHAIN = RetCode.mark(205299,
        "not found group by chain and groupId");
    public static final RetCode GET_LIST_MANAGER_FAIL = RetCode.mark(205300,
        "get list of manager on chain fail");
    public static final RetCode CRUD_TABLE_KEY_LENGTH_ERROR = RetCode.mark(205301,
        "table key length error");
    public static final RetCode CRUD_PARSE_CONDITION_ENTRY_FIELD_JSON_ERROR = RetCode.mark(205302,
        "crud's param parse json error");
    public static final RetCode PRECOMPILED_COMMON_TRANSFER_JSON_FAIL = RetCode.mark(205303,
        "precompiled common transfer to json fail");
    public static final RetCode TX_RECEIPT_OUTPUT_PARSE_JSON_FAIL = RetCode.mark(205304,
        "transaction receipt fail and parse output fail");
    public static final RetCode TX_RECEIPT_OUTPUT_NULL = RetCode.mark(205305,
        "transaction receipt fail and output is null");


    // 1.5.3
    public static final RetCode CONTRACT_PATH_IS_EXISTS = RetCode.mark(205310,
        "contract path is exists.");
    public static final RetCode FUNC_PARAM_SIZE_NOT_MATCH = RetCode.mark(201322,
        "contract funcParam size not match with ABI");
    public static final RetCode FUNC_PARAM_BYTES_SIZE_NOT_MATCH = RetCode.mark(201323,
        "contract funcParam bytes array size not match");

    public static final RetCode IN_FUNCTION_ERROR = RetCode.mark(201019,
        "request function is error");
