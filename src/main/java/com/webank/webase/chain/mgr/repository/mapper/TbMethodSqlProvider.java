...
import com.webank.webase.chain.mgr.repository.bean.TbMethodExample.Criteria;
import com.webank.webase.chain.mgr.repository.bean.TbMethodExample.Criterion;
...
public class TbMethodSqlProvider {
     ...
     * @mbg.generated
     */
    public String countByExample(TbMethodExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("tb_method");
     ...
     * @mbg.generated
     */
    public String deleteByExample(TbMethodExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("tb_method");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated
     */
    public String selectByExample(TbMethodExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TbMethod record = (TbMethod) parameter.get("record");
        TbMethodExample example = (TbMethodExample) parameter.get("example");
        SQL sql = new SQL();
        ...
        if (record.getMethodId() != null) {
            sql.SET("method_id = #{record.methodId,jdbcType=VARCHAR}");
        }
        if (record.getMethodName() != null) {
            sql.SET("method_name = #{record.methodName,jdbcType=VARCHAR}");
        }
        if (record.getMethodType() != null) {
            sql.SET("method_type = #{record.methodType,jdbcType=VARCHAR}");
        }
        if (record.getCreateTime() != null) {
     ...
     * @mbg.generated
     */
    protected void applyWhere(SQL sql, TbMethodExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
        String parmPhrase1;
     ...
     * @mbg.generated
     */
    public String getOneByExample(TbMethodExample example) {
        SQL sql = new SQL();
        if (example != null && example.isDistinct()) {
            sql.SELECT_DISTINCT("id");
        } else {
