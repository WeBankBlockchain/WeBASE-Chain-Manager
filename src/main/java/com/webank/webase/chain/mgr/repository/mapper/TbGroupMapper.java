...
public interface TbGroupMapper {
    ...
    TbGroup getGroupById(@Param("chainId") String chainId, @Param("groupId") String groupId);

    @Select({ "select max(group_id) from tb_group  where chain_id = #{chainId}" })
    int getMaxGroup(@Param("chainId") String chainId);
    ...
    int deleteByChainIdANdGroupId(@Param("chainId") String chainId, @Param("groupId") String groupId);

    @Update({ "update tb_group set group_status=#{groupStatus},modify_time=NOW() where group_id = #{groupId} and chain_id = #{chainId}" })
    int updateStatus(@Param("chainId") String chainId, @Param("groupId") String groupId, @Param("groupStatus") Integer groupStatus);

    @Select({ "select count(1) from tb_group where chain_id = #{chainId} and group_status = #{groupStatus}" })
    int countByChainIdAndGroupStatus(@Param("chainId") String chainId, @Param("groupStatus") Byte groupStatus);

    @Select({ "select count(1) from tb_group where chain_id = #{chainId} and group_id = #{groupId}" })
    int countByChainIdAndGroupId(@Param("chainId") String chainId, @Param("groupId") String groupId);

    @Select({ "select * from tb_group where chain_id = #{chainId} and group_status = #{groupStatus} order by group_id asc" })
    List<TbGroup> selectByChainIdAndGroupStatus(@Param("chainId") String chainId, @Param("groupStatus") Byte groupStatus);

    @Select({ "select * from tb_group where chain_id = #{chainId} order by group_id asc" })
    List<TbGroup> selectByChainId(@Param("chainId") String chainId);
    ...
    int updateNodeCount(@Param("chainId") String chainId, @Param("groupId") String groupId, @Param("nodeCount") int nodeCount);
    ...
    int deleteByPrimaryKey(@Param("groupId") String groupId, @Param("chainId") String chainId);
    ...
    @Results({ @Result(column = "group_id", property = "groupId", jdbcType =JdbcType.VARCHAR, id = true), @Result(column = "chain_id", property = "chainId", jdbcType =JdbcType.VARCHAR, id = true), @Result(column = "group_name", property = "groupName", jdbcType = JdbcType.VARCHAR), @Result(column = "group_status", property = "groupStatus", jdbcType = JdbcType.TINYINT), @Result(column = "node_count", property = "nodeCount", jdbcType = JdbcType.INTEGER), @Result(column = "description", property = "description", jdbcType = JdbcType.VARCHAR), @Result(column = "group_type", property = "groupType", jdbcType = JdbcType.TINYINT), @Result(column = "create_time", property = "createTime", jdbcType = JdbcType.TIMESTAMP), @Result(column = "modify_time", property = "modifyTime", jdbcType = JdbcType.TIMESTAMP), @Result(column = "group_timestamp", property = "groupTimestamp", jdbcType = JdbcType.VARCHAR), @Result(column = "epoch_sealer_num", property = "epochSealerNum", jdbcType = JdbcType.INTEGER), @Result(column = "node_id_list", property = "nodeIdList", jdbcType = JdbcType.LONGVARCHAR) })
    TbGroup selectByPrimaryKey(@Param("groupId") String groupId, @Param("chainId") String chainId);
