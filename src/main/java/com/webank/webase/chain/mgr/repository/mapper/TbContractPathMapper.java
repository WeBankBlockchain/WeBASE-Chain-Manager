...
public interface TbContractPathMapper {
    ...
    Integer removeByPathName(@Param("chainId") String chainId, @Param("groupId") String groupId,
    ...
    TbContractPath findOne(@Param("chainId") String chainId, @Param("groupId") String groupId,
        @Param("contractPath") String contractPath);
    ...
    List<TbContractPath> listContractPath(@Param("chainId") String chainId,
        @Param("groupId") String groupId);

    @Delete({ "delete from tb_contract_path where chain_id = #{chainId}" })
    int removeByChainId(@Param("chainId") String chainId);

    @Delete({
        "delete from tb_contract_path",
        "where chain_id = #{chainId,jdbcType=INTEGER} and group_id = #{groupId,jdbcType=INTEGER}"
    })
    int removeByGroupId(@Param("chainId") String chainId, @Param("groupId") String groupId);
