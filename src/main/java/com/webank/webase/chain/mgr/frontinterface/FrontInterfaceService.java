...
//            HttpEntity entity = buildHttpEntity(httpHeaders,param);// build entity
    ...
    private <T> T getFromSpecificFront(String groupId, String frontIp, Integer frontPort,
        ...
        return requestSpecificFront(groupId, frontIp, frontPort, HttpMethod.GET, uri, entity,
            clazz);
    }
     ...
     */
    public <T> T postToSpecificFront(String groupId, String frontIp, Integer frontPort, String uri,
     ...
     */
    public <T> T deleteToSpecificFront(String groupId, String frontIp, Integer frontPort,
        String uri, HttpEntity entity, Class<T> clazz) {
     ...
     */
    public List<String> getGroupListFromSpecificFront(String peerName, String frontIp,
        Integer frontPort) {
        String groupId = GROUPID;
        HttpEntity entity = HttpEntityUtils.buildHttpEntityByHost(peerName);
        return getFromSpecificFront(groupId, frontIp, frontPort, URI_GROUP_PLIST, entity,
            List.class);
    }
     ...
     */
    public List<String> getGroupPeersFromSpecificFront(String peerName, String frontIp,
        Integer frontPort, String groupId) {
        HttpEntity entity = HttpEntityUtils.buildHttpEntityByHost(peerName);
        return getFromSpecificFront(groupId, frontIp, frontPort, URI_GROUP_PEERS, entity,
            List.class);
    }
     ...
     * get peers from specific front.
     */
    public SyncStatus getSyncStatusFromSpecificFront(String peerName, String frontIp,
        Integer frontPort, String groupId) {
        HttpEntity entity = HttpEntityUtils.buildHttpEntityByHost(peerName);
     ...
     */
    public List<String> getSealerListFromSpecificFront(String peerName, String frontIp,
        Integer frontPort, String groupId) {
        HttpEntity entity = HttpEntityUtils.buildHttpEntityByHost(peerName);
     ...
     */
    public Integer getEncryptTypeFromSpecificFront(String peerName, String nodeIp,
        Integer frontPort) {
        ...
        HttpEntity entity = HttpEntityUtils.buildHttpEntityByHost(peerName);
        int encryptType =
            getFromSpecificFront(groupId, nodeIp, frontPort, URI_ENCRYPT_TYPE, entity,
                Integer.class);
     ...
     * @return
     */
    public ClientVersionDTO getClientVersionFromSpecificFront(String peerName, String nodeIp,
        Integer frontPort) {
        log.debug("start getClientVersionFromSpecificFront. nodeIp:{},frontPort:{}", nodeIp,
            frontPort);
        String groupId = GROUPID;
        HttpEntity entity = HttpEntityUtils.buildHttpEntityByHost(peerName);
        ClientVersionDTO clientVersionDTO = getFromSpecificFront(groupId, nodeIp, frontPort,
            URI_CLIENT_VERSION, entity, ClientVersionDTO.class);
        log.debug("end getClientVersionFromSpecificFront. clientVersionDTO:{}",
     ...
     */
    public List<String> getObserverListFromSpecificFront(String peerName, String frontIp,
        Integer frontPort, String groupId) {
        HttpEntity entity = HttpEntityUtils.buildHttpEntityByHost(peerName);
        return getFromSpecificFront(groupId, frontIp, frontPort,
            FrontRestTools.URI_GET_OBSERVER_LIST, entity, List.class);
    }

    public BigInteger getBlockNumberFromSpecificFront(String peerName, String frontIp,
        Integer frontPort, String groupId) {
        HttpEntity entity = HttpEntityUtils.buildHttpEntityByHost(peerName);
    ...
    public Block getBlockByNumberFromSpecificFront(String peerName, String frontIp,
        Integer frontPort, String groupId, BigInteger blockNmber) {
        HttpEntity entity = HttpEntityUtils.buildHttpEntityByHost(peerName);
    ...
    public TransactionCount getTotalTransactionCountFromSpecificFront(String peerName,
        String frontIp, Integer frontPort, String groupId) {
        HttpEntity entity = HttpEntityUtils.buildHttpEntityByHost(peerName);
    ...
    public JsonTransactionResponse getTransactionByHashFromSpecificFront(String peerName,
        String frontIp, Integer frontPort, String groupId, String transHash) {
        HttpEntity entity = HttpEntityUtils.buildHttpEntityByHost(peerName);
        String uri = String.format(FrontRestTools.URI_TRANS_BY_HASH, transHash);
        return getFromSpecificFront(groupId, frontIp, frontPort, uri, entity,
            JsonTransactionResponse.class);
    }

    public TransactionReceipt getTransactionReceiptFromSpecificFront(String peerName,
        String frontIp, Integer frontPort, String groupId, String transHash) {
        HttpEntity entity = HttpEntityUtils.buildHttpEntityByHost(peerName);
     ...
     * get peers.
     */
    public PeerInfo[] getPeers(String chainId, String groupId) {
     ...
     * get contract code.
     */
    public String getContractCode(String chainId, String groupId, String address,
     ...
     * get group peers
     */
    public List<String> getGroupPeers(String chainId, String groupId) {
     ...
     * get consensusStatus
     */
    public ConsensusStatusInfo getConsensusStatus(String chainId, String groupId) {
        log.debug("start getConsensusStatus. groupId:{}", groupId);
        ConsensusStatusInfo consensusStatus = frontRestTools.getForEntity(chainId, groupId,
    ...
    public List<String> getNodeIdList(String chainId, String groupId) {
     ...
     * get syncStatus
     */
    public SyncStatus getSyncStatus(String chainId, String groupId) {
    ...
    public List<String> getSealerList(String chainId, String groupId) {
...
//    }
    ...
    public Object setConsensusStatus(String peerName, String frontIp, Integer frontPort,
        ...
        log.debug("start setConsensusStatus. consensusParam:{}",
            JsonTools.toJSONString(consensusParam));
    ...
    public Object getSysConfigList(String peerName, String frontIp, Integer frontPort,
        String groupId,
...
//    }
    ...
    public Object sendQueryTransaction(String chainId, String groupId, Object params) {
     ...
     * @return
     */
    public RspContractCompileDto compileSingleContractFile(String chainId, String groupId,
        String contractName, String contractSource) {
        ReqContractCompileDto param = new ReqContractCompileDto(contractName, contractSource);
        return frontRestTools.postForEntity(chainId, groupId, FrontRestTools.URI_CONTRACT_COMPILE,
    ...
    public Object getPerformanceRatio(String peerName, String frontIp, Integer frontPort,
        Map<String, String> map) {
        String uri = HttpRequestTools.getQueryUri(FrontRestTools.URI_FRONT_PERFORMANCE_RATIO, map);
        HttpEntity entity = HttpEntityUtils.buildHttpEntityByHost(peerName);
        Object frontRsp =
            getFromSpecificFront(GROUPID, frontIp, frontPort, uri, entity, Object.class);
        return frontRsp;
...
//    }
    ...
    public Block getBlockByNumber(String chainId, String groupId, BigInteger blockNumber)
        throws BaseException {
     ...
     */
    public List<NodeStatusInfo> getNodeStatusList(String chainId, String groupId) {
        List nodeStatusList = frontRestTools.getForEntity(chainId, groupId,
