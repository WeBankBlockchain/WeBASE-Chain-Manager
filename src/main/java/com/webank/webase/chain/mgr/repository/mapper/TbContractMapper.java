...
public interface TbContractMapper {
     ...
     * @mbg.generated
     */
    @Insert({ "insert into tb_contract (contract_path, contract_name, ", "chain_id, group_id, ", "agency_id, contract_address, ", "deploy_time, contract_status, ", "contract_type, description, ", "create_time, modify_time, ", "contract_source, contract_abi, ", "contract_bin, bytecode_bin)", "values (#{contractPath,jdbcType=VARCHAR}, #{contractName,jdbcType=VARCHAR}, ", "#{chainId,jdbcType=INTEGER}, #{groupId,jdbcType=INTEGER}, ", "#{agencyId,jdbcType=INTEGER}, #{contractAddress,jdbcType=VARCHAR}, ", "#{deployTime,jdbcType=TIMESTAMP}, #{contractStatus,jdbcType=TINYINT}, ", "#{contractType,jdbcType=TINYINT}, #{description,jdbcType=VARCHAR}, ", "#{createTime,jdbcType=TIMESTAMP}, #{modifyTime,jdbcType=TIMESTAMP}, ", "#{contractSource,jdbcType=LONGVARCHAR}, #{contractAbi,jdbcType=LONGVARCHAR}, ", "#{contractBin,jdbcType=LONGVARCHAR}, #{bytecodeBin,jdbcType=LONGVARCHAR})" })
     ...
     * @mbg.generated
     */
    @Select({ "select", "contract_id, contract_path, contract_name, chain_id, group_id, agency_id, contract_address, ", "deploy_time, contract_status, contract_type, description, create_time, modify_time, ", "contract_source, contract_abi, contract_bin, bytecode_bin", "from tb_contract", "where contract_id = #{contractId,jdbcType=INTEGER}" })
    @Results({ @Result(column = "contract_id", property = "contractId", jdbcType = JdbcType.INTEGER, id = true), @Result(column = "contract_path", property = "contractPath", jdbcType = JdbcType.VARCHAR), @Result(column = "contract_name", property = "contractName", jdbcType = JdbcType.VARCHAR), @Result(column = "chain_id", property = "chainId", jdbcType = JdbcType.INTEGER), @Result(column = "group_id", property = "groupId", jdbcType = JdbcType.INTEGER), @Result(column = "agency_id", property = "agencyId", jdbcType = JdbcType.INTEGER), @Result(column = "contract_address", property = "contractAddress", jdbcType = JdbcType.VARCHAR), @Result(column = "deploy_time", property = "deployTime", jdbcType = JdbcType.TIMESTAMP), @Result(column = "contract_status", property = "contractStatus", jdbcType = JdbcType.TINYINT), @Result(column = "contract_type", property = "contractType", jdbcType = JdbcType.TINYINT), @Result(column = "description", property = "description", jdbcType = JdbcType.VARCHAR), @Result(column = "create_time", property = "createTime", jdbcType = JdbcType.TIMESTAMP), @Result(column = "modify_time", property = "modifyTime", jdbcType = JdbcType.TIMESTAMP), @Result(column = "contract_source", property = "contractSource", jdbcType = JdbcType.LONGVARCHAR), @Result(column = "contract_abi", property = "contractAbi", jdbcType = JdbcType.LONGVARCHAR), @Result(column = "contract_bin", property = "contractBin", jdbcType = JdbcType.LONGVARCHAR), @Result(column = "bytecode_bin", property = "bytecodeBin", jdbcType = JdbcType.LONGVARCHAR) })
    ...
    @Insert({ "<script>", "insert into tb_contract (contract_path, ", "contract_name, chain_id, ", "group_id, agency_id, ", "contract_address, deploy_time, ", "contract_status, contract_type, ", "description, create_time, ", "modify_time, contract_source, ", "contract_abi, contract_bin, ", "bytecode_bin)", "values<foreach collection=\"list\" item=\"detail\" index=\"index\" separator=\",\">(#{detail.contractPath,jdbcType=VARCHAR}, ", "#{detail.contractName,jdbcType=VARCHAR}, #{detail.chainId,jdbcType=INTEGER}, ", "#{detail.groupId,jdbcType=INTEGER}, #{detail.agencyId,jdbcType=INTEGER}, ", "#{detail.contractAddress,jdbcType=VARCHAR}, #{detail.deployTime,jdbcType=TIMESTAMP}, ", "#{detail.contractStatus,jdbcType=TINYINT}, #{detail.contractType,jdbcType=TINYINT}, ", "#{detail.description,jdbcType=VARCHAR}, #{detail.createTime,jdbcType=TIMESTAMP}, ", "#{detail.modifyTime,jdbcType=TIMESTAMP}, #{detail.contractSource,jdbcType=LONGVARCHAR}, ", "#{detail.contractAbi,jdbcType=LONGVARCHAR}, #{detail.contractBin,jdbcType=LONGVARCHAR}, ", "#{detail.bytecodeBin,jdbcType=LONGVARCHAR})</foreach></script>" })
