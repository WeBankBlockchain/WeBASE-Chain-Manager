...
public interface TbContractMapper {
    ...
    //    String getSystemContractBin(@Param("groupId") String groupId, @Param("contractName") String contractName);
    ...
    TbContract getContract(@Param("chainId") String chainId, @Param("groupId") String groupId, @Param("name") String name, @Param("path") String path);
    ...
    int updateSystemContract(@Param("groupId") String groupId, @Param("contractName") String contractName, @Param("contractBin") String contractBin, @Param("contractAddress") String contractAddress);
