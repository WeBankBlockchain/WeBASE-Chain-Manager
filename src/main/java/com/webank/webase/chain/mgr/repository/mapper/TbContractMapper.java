...
public interface TbContractMapper {
     ...
     * @mbg.generated
     */
    @Insert({ "insert into tb_contract (contract_path, contract_name, ", "chain_id, group_id, ", "contract_address, deploy_time, ", "contract_status, contract_type, ", "description, create_time, ", "modify_time, contract_source, ", "contract_abi, contract_bin, ", "bytecode_bin)", "values (#{contractPath,jdbcType=VARCHAR}, #{contractName,jdbcType=VARCHAR}, ", "#{chainId,jdbcType=INTEGER}, #{groupId,jdbcType=INTEGER}, ", "#{contractAddress,jdbcType=VARCHAR}, #{deployTime,jdbcType=TIMESTAMP}, ", "#{contractStatus,jdbcType=TINYINT}, #{contractType,jdbcType=TINYINT}, ", "#{description,jdbcType=VARCHAR}, #{createTime,jdbcType=TIMESTAMP}, ", "#{modifyTime,jdbcType=TIMESTAMP}, #{contractSource,jdbcType=LONGVARCHAR}, ", "#{contractAbi,jdbcType=LONGVARCHAR}, #{contractBin,jdbcType=LONGVARCHAR}, ", "#{bytecodeBin,jdbcType=LONGVARCHAR})" })
