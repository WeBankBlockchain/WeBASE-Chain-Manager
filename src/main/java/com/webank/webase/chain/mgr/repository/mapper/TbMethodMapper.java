...
public interface TbMethodMapper {
    ...
    @Insert({"replace into tb_method",
            "(contract_id,chain_id,group_id,method_id,method_name,method_type,create_time,modify_time) VALUES",
     ...
     */
    @Select({"select",
            "id, contract_id, chain_id, group_id, method_id, method_name, method_type, create_time, ",
            "modify_time", "from tb_method", "where id = #{id,jdbcType=INTEGER}"})
    @Results({@Result(column = "id", property = "id", jdbcType = JdbcType.INTEGER, id = true),
            ...
            @Result(column = "method_id", property = "methodId", jdbcType = JdbcType.VARCHAR),
    ...
    @Insert({"<script>", "insert into tb_method (contract_id, ", "chain_id, group_id, ",
            "method_id, method_name, ", "method_type, create_time, ", "modify_time)",
            "values<foreach collection=\"list\" item=\"detail\" index=\"index\" separator=\",\">(#{detail.contractId,jdbcType=INTEGER}, ",
            "#{detail.chainId,jdbcType=INTEGER}, #{detail.groupId,jdbcType=INTEGER}, ",
            "#{detail.methodId,jdbcType=VARCHAR}, #{detail.methodName,jdbcType=VARCHAR}, ",
            "#{detail.methodType,jdbcType=VARCHAR}, #{detail.createTime,jdbcType=TIMESTAMP}, ",
            "#{detail.modifyTime,jdbcType=TIMESTAMP})</foreach></script>",})
    int batchInsert(java.util.List<TbMethod> list);
}
