...
public interface TbUserMapper {
     ...
     * @mbg.generated
     */
    @Insert({ "insert into tb_user (sign_user_id, user_name, ", "chain_id, group_id, ", "user_status, gmt_create, ", "gmt_modified, description)", "values (#{signUserId,jdbcType=VARCHAR}, #{userName,jdbcType=VARCHAR}, ", "#{chainId,jdbcType=INTEGER}, #{groupId,jdbcType=INTEGER}, ", "#{userStatus,jdbcType=INTEGER}, #{gmtCreate,jdbcType=TIMESTAMP}, ", "#{gmtModified,jdbcType=TIMESTAMP}, #{description,jdbcType=VARCHAR})" })
     ...
     * @mbg.generated
     */
    @Select({ "select", "id, sign_user_id, user_name, chain_id, group_id, user_status, gmt_create, gmt_modified, ", "description", "from tb_user", "where id = #{id,jdbcType=INTEGER}" })
    @Results({ @Result(column = "id", property = "id", jdbcType = JdbcType.INTEGER, id = true), @Result(column = "sign_user_id", property = "signUserId", jdbcType = JdbcType.VARCHAR), @Result(column = "user_name", property = "userName", jdbcType = JdbcType.VARCHAR), @Result(column = "chain_id", property = "chainId", jdbcType = JdbcType.INTEGER), @Result(column = "group_id", property = "groupId", jdbcType = JdbcType.INTEGER), @Result(column = "user_status", property = "userStatus", jdbcType = JdbcType.INTEGER), @Result(column = "gmt_create", property = "gmtCreate", jdbcType = JdbcType.TIMESTAMP), @Result(column = "gmt_modified", property = "gmtModified", jdbcType = JdbcType.TIMESTAMP), @Result(column = "description", property = "description", jdbcType = JdbcType.VARCHAR) })
    ...
    @Insert({ "<script>", "insert into tb_user (sign_user_id, ", "user_name, chain_id, ", "group_id, user_status, ", "gmt_create, gmt_modified, ", "description)", "values<foreach collection=\"list\" item=\"detail\" index=\"index\" separator=\",\">(#{detail.signUserId,jdbcType=VARCHAR}, ", "#{detail.userName,jdbcType=VARCHAR}, #{detail.chainId,jdbcType=INTEGER}, ", "#{detail.groupId,jdbcType=INTEGER}, #{detail.userStatus,jdbcType=INTEGER}, ", "#{detail.gmtCreate,jdbcType=TIMESTAMP}, #{detail.gmtModified,jdbcType=TIMESTAMP}, ", "#{detail.description,jdbcType=VARCHAR})</foreach></script>" })
