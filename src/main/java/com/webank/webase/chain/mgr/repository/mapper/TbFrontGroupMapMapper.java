...
public interface TbFrontGroupMapMapper {
    ...
    List<FrontGroup> selectByGroupId(@Param("groupId") String groupId);
    ...
    List<FrontGroup> selectByChainIdAndGroupId(@Param("chainId") String chainId, @Param("groupId") String groupId);
    ...
    List<FrontGroup> selectByChainId(@Param("chainId") String chainId);
    ...
    int deleteByGroupId(@Param("chainId") String chainId, @Param("groupId") String groupId);

    @Delete({ "delete from tb_front_group_map where chain_id = #{chainId} and front_id = #{frontId} and group_id = #{groupId}" })
    int deleteByChainIdAndFrontIdAndGroupId(@Param("chainId") String chainId, @Param("frontId") int frontId, @Param("groupId") String groupId);

    @Select({ "select * from tb_front_group_map where chain_id = #{chainId} and front_id = #{frontId} and group_id = #{groupId}" })
    TbFrontGroupMap selectByChainIdAndFrontIdAndGroupId(@Param("chainId") String chainId, @Param("frontId") int frontId, @Param("groupId") String groupId);

    @Select({ "select * from tb_front_group_map where chain_id=#{chainId} and group_id=#{groupId} order by create_time desc" })
    List<TbFrontGroupMap> selectListByGroupId(@Param("chainId") String chainId, @Param("groupId") String groupId);
