...
public interface TbFrontGroupMapMapper {
    ...
    @Select({ "select a.map_id as map_id, a.chain_id as chain_id, a.group_id as group_id, a.front_id as front_id, " + "b.front_ip as front_ip,b.front_port as front_port from tb_front_group_map a left join tb_front b " + "on(a.front_id=b.front_id) left join tb_group c " + "on(a.chain_id=c.chain_id and a.group_id=c.group_id) left join tb_chain d " + "on(a.chain_id=d.chain_id) where a.group_id = #{groupId} " })
    List<FrontGroup> selectByGroupId(@Param("groupId") int groupId);

    @Select({ "select a.map_id as map_id, a.chain_id as chain_id, a.group_id as group_id, a.front_id as front_id," + "b.front_ip as front_ip,b.front_port as front_port from tb_front_group_map a left join tb_front b " + "on(a.front_id=b.front_id) left join tb_group c " + "on(a.chain_id=c.chain_id and a.group_id=c.group_id) left join tb_chain d " + "on(a.chain_id=d.chain_id) where a.group_id = #{groupId}  and a.chain_id = #{chainId} " })
    List<FrontGroup> selectByChainIdAndGroupId(@Param("chainId") int chainId, @Param("groupId") int groupId);

    @Select({ "select a.map_id as map_id, a.chain_id as chain_id, a.group_id as group_id, a.front_id as front_id," + "b.front_ip as front_ip,b.front_port as front_port from tb_front_group_map a left join tb_front b " + "on(a.front_id=b.front_id) left join tb_group c " + "on(a.chain_id=c.chain_id and a.group_id=c.group_id) left join tb_chain d " + "on(a.chain_id=d.chain_id) where a.chain_id = #{chainId} " })
...
//    @Select({
//            "update tb_front_group_map set modify_time = now(),front_status=#{status} where front_id=#{frontId} and chain_id=#{chainId}"
//    })
//    void updateAllGroupsStatus(@Param("chainId") int chainId,@Param("frontId") int frontId,@Param("status") int status);
//
//    @Select({
//            "update tb_front_group_map set modify_time = now(),front_status=#{status} where front_id=#{frontId} and group_id=${groupId} and chain_id=#{chainId}"
//    })
//    void updateOneGroupStatus(@Param("chainId") int chainId, @Param("frontId") int frontId,@Param("status") byte status,@Param("groupId") int groupId);
