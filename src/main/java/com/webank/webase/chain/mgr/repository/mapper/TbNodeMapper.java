...
public interface TbNodeMapper {
    ...
    int deleteByNodeIdAndGroupId(@Param("nodeId") String nodeId, @Param("groupId") String groupId);
    ...
    int deleteByPrimaryKey(@Param("nodeId") String nodeId, @Param("chainId") String chainId, @Param("groupId") String groupId);
    ...
    @Results({ @Result(column = "node_id", property = "nodeId", jdbcType = JdbcType.VARCHAR, id = true), @Result(column = "chain_id", property = "chainId", jdbcType =JdbcType.VARCHAR, id = true), @Result(column = "group_id", property = "groupId", jdbcType =JdbcType.VARCHAR, id = true), @Result(column = "node_name", property = "nodeName", jdbcType = JdbcType.VARCHAR), @Result(column = "node_type", property = "nodeType", jdbcType = JdbcType.VARCHAR), @Result(column = "node_ip", property = "nodeIp", jdbcType = JdbcType.VARCHAR), @Result(column = "p2p_port", property = "p2pPort", jdbcType = JdbcType.INTEGER), @Result(column = "block_number", property = "blockNumber", jdbcType = JdbcType.BIGINT), @Result(column = "pbft_view", property = "pbftView", jdbcType = JdbcType.BIGINT), @Result(column = "node_active", property = "nodeActive", jdbcType = JdbcType.TINYINT), @Result(column = "description", property = "description", jdbcType = JdbcType.VARCHAR), @Result(column = "create_time", property = "createTime", jdbcType = JdbcType.TIMESTAMP), @Result(column = "modify_time", property = "modifyTime", jdbcType = JdbcType.TIMESTAMP) })
    TbNode selectByPrimaryKey(@Param("nodeId") String nodeId, @Param("chainId") String chainId, @Param("groupId") String groupId);
