...
public interface TbNodeMapper {
     ...
     * @mbg.generated
     */
    @Insert({ "insert into tb_node (node_id, chain_id, ", "group_id, node_name, ", "node_ip, p2p_port, ", "block_number, pbft_view, ", "node_active, description, ", "create_time, modify_time)", "values (#{nodeId,jdbcType=VARCHAR}, #{chainId,jdbcType=INTEGER}, ", "#{groupId,jdbcType=INTEGER}, #{nodeName,jdbcType=VARCHAR}, ", "#{nodeIp,jdbcType=VARCHAR}, #{p2pPort,jdbcType=INTEGER}, ", "#{blockNumber,jdbcType=BIGINT}, #{pbftView,jdbcType=BIGINT}, ", "#{nodeActive,jdbcType=TINYINT}, #{description,jdbcType=VARCHAR}, ", "#{createTime,jdbcType=TIMESTAMP}, #{modifyTime,jdbcType=TIMESTAMP})" })
     ...
     * @mbg.generated
     */
    @Update({ "update tb_node", "set node_name = #{nodeName,jdbcType=VARCHAR},", "node_ip = #{nodeIp,jdbcType=VARCHAR},", "p2p_port = #{p2pPort,jdbcType=INTEGER},", "block_number = #{blockNumber,jdbcType=BIGINT},", "pbft_view = #{pbftView,jdbcType=BIGINT},", "node_active = #{nodeActive,jdbcType=TINYINT},", "description = #{description,jdbcType=VARCHAR},", "create_time = #{createTime,jdbcType=TIMESTAMP},", "modify_time = #{modifyTime,jdbcType=TIMESTAMP}", "where node_id = #{nodeId,jdbcType=VARCHAR}", "and chain_id = #{chainId,jdbcType=INTEGER}", "and group_id = #{groupId,jdbcType=INTEGER}" })
