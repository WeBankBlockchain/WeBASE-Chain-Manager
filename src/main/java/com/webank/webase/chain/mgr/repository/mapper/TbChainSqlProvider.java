...
public class TbChainSqlProvider {
     ...
     * @mbg.generated
     */
    public static final String ALL_COLUMN_FIELDS = "chain_id,chain_type,description,create_time,modify_time,version,consensus_type,storage_type,chain_status,webase_sign_addr";
