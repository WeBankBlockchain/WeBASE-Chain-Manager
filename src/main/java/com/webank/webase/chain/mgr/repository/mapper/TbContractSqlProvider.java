...
public class TbContractSqlProvider {
     ...
     * @mbg.generated
     */
    public static final String ALL_COLUMN_FIELDS = "contract_id,contract_path,contract_name,chain_id,group_id,agency_id,contract_address,deploy_time,contract_status,contract_type,description,create_time,modify_time,contract_source,contract_abi,contract_bin,bytecode_bin";
