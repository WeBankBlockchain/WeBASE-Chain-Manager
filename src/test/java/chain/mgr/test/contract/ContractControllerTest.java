...
public class ContractControllerTest {
    ...
    public void testSaveContract() throws Exception {
        ...
        ResultActions resultActions = mockMvc.perform(MockMvcRequestBuilders.post("/contract/save")
                .content(JSON.toJSONString(testUpdate)).contentType(MediaType.APPLICATION_JSON));
    ...
    public void testFindByPartOfBytecodeBin() throws Exception {
        ...
        ResultActions resultActions =
                mockMvc.perform(MockMvcRequestBuilders.post("/contract/findByPartOfBytecodeBin")
                        .content(JSON.toJSONString(param)).contentType(MediaType.APPLICATION_JSON));
        resultActions.andExpect(MockMvcResultMatchers.status().isOk())
                .andDo(MockMvcResultHandlers.print());
        System.out.println(
