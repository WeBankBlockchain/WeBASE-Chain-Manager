...
CREATE TABLE IF NOT EXISTS tb_chain (
  ...
  version varchar(64) NULL DEFAULT '' COMMENT '创建链时选择的镜像版本',
  consensus_type varchar(16) NULL DEFAULT 'pbft' COMMENT '共识算法 pbft,raft',
  storage_type varchar(16) NULL DEFAULT 'RocksDB' COMMENT '存储类型（支持：RocksDB, LevelDB, MySQL）',
...
CREATE TABLE IF NOT EXISTS tb_group (
    ...
    create_time datetime DEFAULT NULL COMMENT '创建时间',
    modify_time datetime DEFAULT NULL COMMENT '修改时间',
    group_timestamp varchar(64) NULL DEFAULT '' COMMENT '群组创世块时间戳',
...
CREATE TABLE IF NOT EXISTS tb_front (
    ...
    root_on_host varchar(256) NULL DEFAULT '/opt/fisco' COMMENT 'front 所在主机存放节点数据的根目录，比如: /opt/fisco',
    node_root_on_host varchar(256) NULL DEFAULT '' COMMENT '节点根目录，比如: /opt/fisco/[chain_name]/node0',
